...
#define V_STR3 "ADD%s加法"
#define V_STR4 "SUB%s减法"
#define V_STR5 "MUL%s乘法"
#define V_STR6 "DIV%s除法"
#define V_STR7 "MENU%s显示菜单"
#define V_STR8 "ETR%s重新输入两个整数"
#define V_STR9 "EXIT%s退出"
#define V_STRa "*************************%c"
#define V_STRb "请选择指令："
#define V_STRc "执行加法运算，%d + %d = %d"
#define V_STRd "执行减法运算，%d - %d = %d"
#define V_STRe "执行乘法运算，%d * %d = %d"
#define V_STRf "执行除法运算，%d / %d = %0.3f"
